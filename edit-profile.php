                        ...
                        <div class="col-sm-12 col-md-12 no-pad">
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-3 col-lg-4"></div>
                                    <div class="col-sm-6 col-md-6 mt-5 col-lg-4 cust-profile">
                                        <div class="myprofile">
                                            ...
                                            <form>
                                                <div class="input-group mb-4 mr-sm-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text custr-inpgrptxt"><i class="fa fa-user" aria-hidden="true"></i></div>
                                                    </div>
                                                    <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter User Name">
                                                </div>
                                                <div class="input-group mb-4 mr-sm-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text custr-inpgrptxt"><i class="fa fa-at" aria-hidden="true"></i></div>
                                                    </div>
                                                    <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter Email Id">
                                                </div>
                                                <div class="input-group mb-5 mr-sm-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text custr-inpgrptxt"><i class="fa fa-mobile mob" aria-hidden="true"></i></div>
                                                    </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 mb-2">
                                                <button class="btn edit-btn">SAVE</button>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <button class="btn edit-btn">CANCEL</button>
                                            </div>
                                        </div>
                                    </div>
                                <div class="col-sm-3 col-md-3 col-lg-4"></div>
