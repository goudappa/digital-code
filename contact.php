                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="nav navbar-nav cust-navbarnav ml-auto">
                                ...
                                <li>
                                    <div class="dropdown">
                                        <button class="btn btn-secondary res-shopnow cust-dropbtn2 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        ...
                        <div class="col-sm-12 col-md-12 no-pad">
                           ...
                           <div class="row">
                                <div class="col-sm-4 col-md-4 mt-4">
                                    <div class="location">
                                        <div><i class="fa fa-map-marker cust-loc" aria-hidden="true"></i></div>
                                        <div class="location-item">
                                            <address>
                                            <strong>Digital Code4U</strong> <br>
                                ...
                                <div class="col-sm-4 col-md-4 mt-4">
                                    <div class="location">
                                        <div><i class="fa fa-phone-square cust-loc" aria-hidden="true"></i></div>
                                        <div class="location-item">
                                            <address>
                                ...
                                <div class="col-sm-4 col-md-4 mt-4">
                                    <div class="location">
                                        <div><i class="fa fa-clock cust-loc" aria-hidden="true"></i></div>
                                        <div class="location-item">
                                            <address>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 my-5">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15223.82505508461!2d78.36714539674071!3d17.46180731708614!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb98ef97bac277%3A0x978c227c33ec089f!2sVersatile+Mobitech!5e0!3m2!1sen!2sin!4v1544609794407" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <form>
                                    <div class="form-row">
                                        <div class="form-group col-md-6 col-sm-6" style="padding:0 15px;">
                                        <label class="cst-lbl">Name *</label>
                                        <input type="text" class="form-control contact-frm" id="" placeholder="">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6" style="padding:0 15px;">
                                        <label class="cst-lbl">Last Name *</label>
                                        <input type="text" class="form-control contact-frm" id="" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6 col-sm-6" style="padding:0 15px;">
                                        <label class="cst-lbl">Email Id*</label>
                                        <input type="text" class="form-control contact-frm" id="" placeholder="">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6" style="padding:0 15px;">
                                        <label class="cst-lbl">Mobile Number *</label>
                                        <input type="text" class="form-control contact-frm" id="" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group" style="padding:0 15px;">
                                        <label class="cst-lbl">Subject *</label>
                                        <input type="text" class="form-control contact-frm" id="" placeholder="">
                                    </div>
                                    <div class="form-group" style="padding:0 15px;">
                                        <label class="cst-lbl">Message *</label>
                                        <textarea class="form-control contact-frm" id="" rows="10"></textarea>
                                    </div>
                                    </form>
                                </div>
                            </div>
