                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 no-pad">
                            ...
                            <!-- Order details -->
                            <div class="cust-boxshadow">
                                <div class="row">
                                    <div class="col-sm-2 col-md-2">
                                        <div class="cartimg1 orderimg">
                                            <img src="images/cart1.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4">
                                        <div class="itunes">
                                            <h5>iTunes 50 SAR - Saudi</h5>
                                                <p>50 SAR</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4">
                                        <div class="itunes itunes2">
                                            <p>1</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-2 col-md-2">
                                        <div class="cartimg1 orderimg">
                                            <img src="images/cart3.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4">
                                        <div class="itunes">
                                            <h5>Zain 250 SAR - Amazon</h5>
                                                <p>100 SAR</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4">
                            ...
                            <div class="">
                                <div class="row cust-boxshadow">
                                    <div class="col-sm-12 col-md-12">
                                        <div class="date-time">
                                            <h5>Date & Time <span class="order-dt">29 Nov, 2018. 3:45 PM</span> </h5>
                                            <h5>Total Amount <span class="order-dt">400 SAR</span></h5>
                                            <h5>Status <span class="order-dt">Pending</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
